    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if_and_else_butt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Advanced.this,AdvancedIfAndElse.class));
            }
        });
        for_loop_butt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Advanced.this,AdvancedForLoops.class));
            }
        });
        while_loop_butt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Advanced.this,AdvancedWhileLoops.class));
            }
        });
