...
public class Expert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int max_level = preferences.getInt("Expert", 1);
        ...
        preferences.edit().putFloat("expert_percentage", percent_rating).apply();
        ...
        butt_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Expert.this,GameMenu.class));
            }
        });
    ...
    private void on_to_game(int level){
        preferences.edit()
                .putInt("level", level)
                .apply();
        startActivity(new Intent(Expert.this,Game.class));
    }
